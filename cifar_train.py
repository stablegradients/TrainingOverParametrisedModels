...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.log_results:
        wandb.init(project=args.project,
                                   entity=args.entity, id=args.runid)
    ...
    if args.loss_type == 'CE':
        ...
        import math
        rho = math.exp(math.log(args.imb_factor)/(num_classes - 1))
        prior_ = [rho ** i for i in range(num_classes)]
        prior_sum = sum(prior_)
        prior = [x/prior_sum for x in prior_]
